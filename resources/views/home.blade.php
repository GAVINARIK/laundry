...
<body>
    ...
    <section id= home-section>
        <div class="container-lg position-relative p-0 px-lg-3" style="z-index: 9;">
            <nav class="navbar fixed-top navbar-expand-lg bg-white navbar-light py-3 py-lg-0 pl-3 pl-lg-5">
            <!-- bg-white navbar-light py-3 py-lg-0 pl-3 pl-lg-5 -->
                <a href="" class="navbar-brand">
                    <h1 class="m-0 text-secondary"><span class="text-primary">DRY</span>Laundry</h1>
                </a>
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="#layanan-section" class="nav-item nav-link">Layanan</a>
                        <!-- <a href="service.html" class="nav-item nav-link">Services</a>                         -->
                        <a href="#harga-section" class="nav-item nav-link">Harga</a>
                        ...
                        <a href="#kontak-section" class="nav-item nav-link">Kontak</a>
                    </div>
                </div>
            </nav>
.        </div>
    ...
    <div class="container-fluid pt-5 pb-3">
        <div class="container">
            ...
            <h1 class="display-4 text-center mb-5">Layanan Kami</h1>
            <div class="row">
                <div class="col-lg-3 col-md-6 pb-1">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center bg-light mb-4 px-4" style="height: 300px;">
                        ...
                        <h4 class="font-weight-bold m-0">Cuci Express</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 pb-1">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center bg-light mb-4 px-4" style="height: 300px;">
    ...
    <div class="container-fluid pt-5">
        <div class="container">
            ...
            <h1 class="display-4 text-center mb-5">Inilah Kerja Kami</h1>
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center mb-5">
                        ...
                        <h3 class="font-weight-bold m-0 mt-2">Terima Pesanan</h3>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center mb-5">
                        ...
                        <h3 class="font-weight-bold m-0 mt-2">Gratis Jemput</h3>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center mb-5">
    ...
    <div class="container-fluid pt-5 pb-3">
        <div class="container">
            ...
            <h1 class="display-4 text-center mb-5">Rincian Harga</h1>
            <div class="row">
                <div class="col-lg-3 mb-3">
                    <div class="bg-light text-center mb-2 pt-4">
                        <div class="d-inline-flex flex-column align-items-center justify-content-center bg-secondary rounded-circle shadow mt-2 mb-4" style="width: 200px; height: 200px; border: 15px solid #ffffff;">
                            <h3 class="text-white">Cuci</h3>
                            <h3 class="text-white">Express</h3>
                            <h1 class="display-5 text-white mb-0">
                                <small class="align-top" style="font-size: 22px; line-height: 45px;"></small>10<small class="align-bottom" style="font-size: 20px; line-height: 40px;">Ribu</small>
                            </h1>
                        </div>
                ...
                <div class="col-lg-3 mb-3">
                    <div class="bg-light text-center mb-2 pt-4">
                        <div class="d-inline-flex flex-column align-items-center justify-content-center bg-primary rounded-circle shadow mt-2 mb-4" style="width: 200px; height: 200px; border: 15px solid #ffffff;">
                            <h3 class="text-white">Cuci</h3>
                            <h3 class="text-white">Setrika</h3>
                            <h1 class="display-5 text-white mb-0">
                                <small class="align-top" style="font-size: 22px; line-height: 45px;"></small>8<small class="align-bottom" style="font-size: 20px; line-height: 40px;">Ribu</small>
                            </h1>
                        </div>
                        <!-- <div class="d-flex flex-column align-items-center py-3">
                            <p>HTML5 & CSS3</p>
                ...
                <div class="col-lg-3 mb-3">
                    <div class="bg-light text-center mb-2 pt-4">
                        <div class="d-inline-flex flex-column align-items-center justify-content-center bg-secondary rounded-circle shadow mt-2 mb-4" style="width: 200px; height: 200px; border: 15px solid #ffffff;">
                            <h3 class="text-white">Cuci</h3>
                            <h3 class="text-white">Lipat</h3>
                            <h1 class="display-5 text-white mb-0">
                                <small class="align-top" style="font-size: 22px; line-height: 45px;"></small>5<small class="align-bottom" style="font-size: 20px; line-height: 40px;">Ribu</small>
                            </h1>
                        </div>
                        <!-- <div class="d-flex flex-column align-items-center py-3">
                            <p>HTML5 & CSS3</p>
                ...
                <div class="col-lg-3 mb-3">
                    <div class="bg-light text-center mb-2 pt-4">
                        <div class="d-inline-flex flex-column align-items-center justify-content-center bg-primary rounded-circle shadow mt-2 mb-4" style="width: 200px; height: 200px; border: 15px solid #ffffff;">
                            <h3 class="text-white">Setrika</h3>
                            <h3 class="text-white">Saja</h3>
                            <h1 class="display-5 text-white mb-0">
                                <small class="align-top" style="font-size: 22px; line-height: 45px;"></small>6<small class="align-bottom" style="font-size: 20px; line-height: 40px;">Ribu</small>
                            </h1>
                        </div>
                        <!-- <div class="d-flex flex-column align-items-center py-3">
                            <p>HTML5 & CSS3</p>
    ...
    <div class="container-fluid bg-primary text-white mt-5 pt-5 px-sm-3 px-md-5">
        <div class="row pt-5">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p><i class="fa fa-map-marker-alt mr-2"></i>Kavling Ranca Mas Blok B No 8 Rancamanyar Kabupaten Bandung</p>
                <!-- <p><i class="fa fa-phone-alt mr-2"></i>082129644243</p> -->
                <p><i class="fa fa-phone-alt mr-2"></i><a class="text-white mb-4 map-link" href="https://wa.me/082129644243" target="_blank">Whatsapp Me 082129644243 </a></p>
                <p><i class="fa fa-envelope mr-2"></i>Purnama_londry@gmail.com</p>                                
            </div>

            <div class="col-lg-2 col-md-6 mb-5">
                <h4 class="text-white mb-4">Quick Links</h4>
                <div class="d-flex flex-column justify-content-start">
                    <a class="text-white mb-2" href="#home-section"><i class="fa fa-angle-right mr-2"></i>Home</a>
                    <a class="text-white mb-2" href="#layanan-section"><i class="fa fa-angle-right mr-2"></i>Layanan</a>
                    <a class="text-white mb-2" href="#harga-section"><i class="fa fa-angle-right mr-2"></i>Harga</a>                    
                    <a class="text-white" href="#kontak-section"><i class="fa fa-angle-right mr-2"></i>Kontak</a>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-5">        
              <div class="map-responsive map-link">
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d832.7628292016002!2d107.59631206950996!3d-6.9933400995629755!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e941cdb42a8d%3A0x35dc9ce6c7b92c32!2sBlk.%20B%20No.8%2C%20Rancamanyar%2C%20Kec.%20Baleendah%2C%20Kabupaten%20Bandung%2C%20Jawa%20Barat%2040375%2C%20Indonesia!5e1!3m2!1sen!2sus!4v1706583105471!5m2!1sen!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>              
              </div>
            </div>
    ...
    <div class="container-fluid bg-dark text-white py-4 px-sm-3 px-md-5">
        <p class="m-0 text-center text-white">
            &copy; <a class="text-white font-weight-medium" href="#">2023 Purnama Laundry</a>. All Rights Reserved. 
			
			<!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
			Designed by <a class="text-white font-weight-medium" href="">Sevent It</a>
        </p>
    </div>
</section>
    <!-- Footer End -->
